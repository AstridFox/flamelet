...
const namedPalettes: Record<string, string[]> = {
    fire: [
        '#000000', '#220000', '#440000', '#660000', '#882200', '#aa2200', '#cc3300',
        '#ff4400', '#ff5500', '#ff6600', '#ff7700', '#ff8800', '#ffaa00', '#ffcc00',
        '#ffee00', '#ffff66', '#ffff99', '#ffffcc', '#ffffee', '#ffffff'
    ],
    ice: [
        '#000000', '#001122', '#002244', '#003366', '#004488', '#0055aa', '#0066cc',
        '#0077ee', '#0099ff', '#33bbff', '#66ccff', '#99ddff', '#bbeeff', '#ddf5ff',
        '#eeffff', '#ffffff', '#ccffff', '#99ffff', '#66ffff', '#33ffff'
    ],
    forest: [
        '#001f00', '#003300', '#004d00', '#006600', '#007f00', '#009900', '#00b300',
        '#00cc00', '#00e600', '#00ff00', '#33ff33', '#66ff66', '#99ff99', '#bbffbb',
        '#ddffdd', '#eeffee', '#f2fff2', '#ccffcc', '#aaffaa', '#88ff88'
    ],
    sunset: [
        '#33001a', '#4d0026', '#660033', '#800040', '#99004d', '#b30059', '#cc0066',
        '#e60073', '#ff0080', '#ff3399', '#ff66b2', '#ff99cc', '#ffcce5', '#ffe6f2',
        '#fff0f5', '#ffdddd', '#ffbbbb', '#ffaaaa', '#ffaaff', '#ffccff'
    ],
    ocean: [
        '#000033', '#000044', '#001155', '#002266', '#003377', '#004488', '#005599',
        '#0066aa', '#0077bb', '#0088cc', '#0099dd', '#00aaee', '#00bbff', '#33ccff',
        '#66ddff', '#99eeff', '#ccf7ff', '#e6fbff', '#f0fdff', '#ffffff'
    ],
    neon: [
    ...
    grayscale: [
        ...
        '#eeeeee', '#f0f0f0', '#f5f5f5', '#fafafa', '#fefefe', '#ffffff'
    ],
    candy: [
        '#ff99cc', '#ffb3d9', '#ffccff', '#ffb3ff', '#e6ccff', '#ccccff', '#b3e6ff',
        '#99ffff', '#b3ffe6', '#ccffcc', '#e6ffb3', '#ffff99', '#ffe699', '#ffc299',
        '#ffa3a3', '#ff8cb3', '#ff9acc', '#ffbce6', '#ffdfff', '#ffffff'
    ],
    lava: [
        '#000000', '#1a0000', '#330000', '#4d0000', '#660000', '#800000', '#990000',
        '#b30000', '#cc0000', '#e60000', '#ff0000', '#ff3300', '#ff6600', '#ff9900',
        '#ffcc00', '#ffff00', '#ffff66', '#ffff99', '#fff2cc', '#ffffff'
    ],
    aurora: [
        '#001f33', '#00264d', '#003366', '#004080', '#004d99', '#005ab3', '#0066cc',
        '#0073e6', '#0080ff', '#3399ff', '#66b2ff', '#99ccff', '#cce5ff', '#ffffff',
        '#ccffe6', '#99ffcc', '#66ffb3', '#33ff99', '#00ff80', '#00ff66'
    ],
